...
from rolloutkit.traffic.client import RequestResult
...
class RunReport:
    ...
    def host_id(self) -> str:
        ...
        What rolloutkit can resolve is a property of the host, not of the
    ...
    def sigkill_effective(self) -> bool:
        ...
        `sigkill_sent` records what rolloutkit did; this records what happened.
