...
from rolloutkit.engine.lifecycle import StartupFailure, run_experiment
from rolloutkit.engine.preconditions import evaluate_contracts
from rolloutkit.evidence.model import RunOutcome, Session, new_run_id
...
async def run_session(
    ...
    *,
    ...
    a bug in rolloutkit and not a verdict about the image. Letting a
